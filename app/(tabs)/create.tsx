...
export default function CreateScreen() {
  ...
  if (role !== "instructor") {
    return <Redirect href="/(tabs)?tab=events" />;
  }
  ...
  const handleConfirmCreate = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        e?.message || "Could not create event. Please try again.",
      );
    } finally {
      setLoading(false);
    }
  ...
  if (step === "confirmation") {
    return (
      ...
      >
        ...
        <Text
          style={[styles.successSubtitle, { color: Colors[colorScheme].icon }]}
        >
      ...
      >
        ...
        >
          ...
          <View
            style={[
              ...
              {
                backgroundColor: colorScheme === "dark" ? "#1c2b33" : "#f5f5f5",
              },
            ]}
          >
            <Text
              style={[styles.detailsLabel, { color: Colors[colorScheme].icon }]}
            >
              OVERVIEW
            </Text>
            <Text
              style={[styles.detailsText, { color: Colors[colorScheme].text }]}
            >
            ...
            {goodToKnow && (
              <>
                <Text
                  style={[
                    styles.detailsLabel,
                    { color: Colors[colorScheme].icon, marginTop: 16 },
                  ]}
                >
                  GOOD TO KNOW
                </Text>
        ...
        >
          <TouchableOpacity
            style={[
              styles.secondaryButton,
              { flex: 1, borderColor: Colors[colorScheme].icon },
            ]}
            onPress={() => setStep("form")}
          >
            <Text
            ...
            >
              {image ? (
                ...
                <View style={styles.imagePlaceholder}>
                  ...
                  />
                  <Text
                    style={{ color: Colors[colorScheme].icon, marginTop: 8 }}
                  >

...
export default function ExploreScreen() {
  ...
  // Student View (Standard Explore content)
  return (
    <View style={[styles.container, { paddingTop: insets.top, backgroundColor: Colors[colorScheme].background }]}>
       <View style={styles.centeredContent}>
        <IconSymbol name="safari.fill" size={64} color="#FFB347" />
        <Text style={[styles.title, { color: Colors[colorScheme].text }]}>Explore</Text>

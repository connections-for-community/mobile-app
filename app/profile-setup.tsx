    ...
    try {
      ...
      const { error: authError } = await supabase.auth.updateUser({
        data: {
          ...
          avatar_url: avatarUrl, // Legacy field for compatibility
      ...
      const profileUpdates = {
        ...
        profile_image_url: avatarUrl || user?.user_metadata?.avatar_url,
      ...
      if (profileError) {
        ...
        Alert.alert(
          "Profile Warning",
          "Your profile details were saved to your account, but the public profile sync failed. Please contact support if this persists.",
        );
      }
    ...
    >
      ...
      >
        ...
        <View style={styles.section}>
            ...
            {avatar ? (
              ...
              <View
                style={[
                  ...
                  { backgroundColor: isDark ? "#1c2b33" : "#e0e0e0" },
                ]}
              >
                <IconSymbol
                  name="person.2.fill"
          ...
          <Text style={[styles.sectionHelpText, { color: themeColors.icon }]}>
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            maxLength={160}
          />
          <Text style={[styles.charCount, { color: themeColors.icon }]}>
            {bio.length}/160
          </Text>
        </View>
          ...
          <View style={styles.inputRow}>
            ...
            <TextInput
              style={[
                ...
                {
                  color: themeColors.text,
                  borderBottomColor: isDark ? "#37464f" : "#ddd",
                },
              ]}
